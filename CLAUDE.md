...
- **Next.js 16 + React 19**, App Router under `src/app/`. `src/app/layout.tsx` is the root layout. Dev uses Turbopack.
...
- **Theming**: light mode only. No `next-themes`, no `.dark` token block.
